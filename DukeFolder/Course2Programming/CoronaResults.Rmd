---
title: "Arizona/US/India Corona Trends- 3rd April 2020 with tomorrow's prediction"
...
```{r include=FALSE}
#Arizona
absolutenumbers <- c(1769,1598,1413,1289,1157,919,773,665,508,401,326,234,152,104,71,44,28,20,18,12)
...
#America
absolutenumbers <- c(265.506*1000,235.281*1000,205.035*1000,176.518*1000,145.369*1000,133.094*1000,123.578*1000,101.7*1000,83.8*1000,65.8*1000,53.7*1000,43.8*1000,33.3*1000,25*1000,19*1000,13.7*1000,7.8*1000,6.4*1000,4.6*1000,3.5*1000,2.7*1000)
```
...
#America
absolutenumbers <- c(2567,2341,1637,1397,1251,1071,1024,987,887,727,657,536,499,396,332,249,194,169,143,129,114,100,82,74,62,62,47,40,34,31,30,29,7,6,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3)
```
